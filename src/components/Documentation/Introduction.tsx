    ...
    return (
        <>
         ...
         {docNavbarOpen && (
          <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-40" onClick={() => setDocNavbarOpen(false)} />
            ...
            <h3 className=" text-black text-2xl mt-4 font-semibold mb-6 dark:text-white" >Versiuni pachete</h3>
            <button onClick={() => setDocNavbarOpen(true)} className="p-0"> <Icon icon="gg:menu-right" className="text-3xl lg:hidden block" /></button>
              ...
              <div className="mt-5">
              <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Acest proiect este construit cu Next.js și Tailwind CSS.</p>
              <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Poți folosi structura existentă și o poți personaliza în funcție de nevoile tale.</p>
              <p className="text-base font-medium text-midnight_text dark:text-white dark:text-opacity-50">Pentru personalizare, este util să cunoști Next.js, React, Tailwind și JSX.</p>
              </div>
        ...
        >
          <div className="flex items-center justify-between p-4">
            <h2 className="text-lg font-bold text-midnight_text dark:text-white">Meniu documentație</h2>
            <button onClick={() => setDocNavbarOpen(false)} aria-label="Închide meniul mobil">
