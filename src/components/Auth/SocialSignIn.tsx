    ...
    <>
      <div className="flex gap-4">
        <button
          type="button"
          onClick={() =>
            toast("Autentificarea este dezactivată în varianta statică (SSG).", {
              duration: 3000,
            })
          }
        ...
        >
          ...
          >
            <path
              d="M13.5 22v-7h2.3l.4-3h-2.7V9.9c0-.87.24-1.46 1.5-1.46H16.3V5.76c-.63-.09-1.4-.16-2.31-.16-2.3 0-3.88 1.4-3.88 3.98V12H7.5v3h2.61v7h3.39Z"
              fill="currentColor"
            />
          </svg>
        </button>
