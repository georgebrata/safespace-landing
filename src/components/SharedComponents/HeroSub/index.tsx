...
const HeroSub: FC<HeroSubProps> = ({ title, breadcrumbLinks }) => {
  return (
      <section className="text-center bg-cover pt-36 pb-20 relative dark:bg-darkmode overflow-x-hidden">
        ...
        <div className="container mx-auto lg:max-w-(--breakpoint-xl) md:max-w-(--breakpoint-md) px-4 relative z-1 flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:justify-between">
